...
app.post("/livros", async (req, res) => {
  ...
  // TODO 1: se "titulo" não for uma string não-vazia, devolva status 400
  // com { erro: "titulo é obrigatório" } e pare aqui (sem inserir no banco).

  // TODO 2: se "ano" não for um número inteiro, devolva status 400
  // com { erro: "ano precisa ser um número inteiro" } e pare aqui.
